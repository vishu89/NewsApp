...
class App extends Component {
	...
	constructor(props)
	{
		...
		fetch('https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=eadb6da4bb5847a8b5f5b8a633e53ab9').then(res =>res.json()).then
		( json => {
		...
		{
			// console.log("else");
			app.innerHTML = "<div>" +this.state.output.length+ "</div>";
		}	
		})}
